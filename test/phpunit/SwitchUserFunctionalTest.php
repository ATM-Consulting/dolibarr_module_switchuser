...
/**
 * \file    test/phpunit/SwitchUserFunctionalTest.php
 * \ingroup switchuser
...
/**
 * Class SwitchUserFunctionalTest
 *
 ...
 *
 * @package Testswitchuser
 */
class SwitchUserFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modSwitchUser')->click();
		} else {
			// Disable the module
			$this->byHref('modSwitchUser')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/switchuser/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('switchuser/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/switchuser/admin/about.php');
		$this->authenticate();
		return $this->assertContains('switchuser/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('switchuserwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modSwitchUser_SwitchUserTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modSwitchUser_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
